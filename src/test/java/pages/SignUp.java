...
public class SignUp extends Actions{
    ...
    public void signUpToPage(String name, String email, String password1, String password2){
       /*   press on signup
            ...
            fill: name, email password and 2nd password
...
//        String nameInTextBox = getElementText(By.cssSelector(fullName));
//        Assert.assertEquals(nameInTextBox,name);

        sendKeysToElement(By.cssSelector(emailAddress), timeStamp+email);
